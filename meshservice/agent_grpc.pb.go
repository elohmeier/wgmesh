...
const (
	Agent_Info_FullMethodName                = "/meshservice.Agent/Info"
	Agent_Nodes_FullMethodName               = "/meshservice.Agent/Nodes"
	Agent_WaitForChangeInMesh_FullMethodName = "/meshservice.Agent/WaitForChangeInMesh"
	Agent_Tag_FullMethodName                 = "/meshservice.Agent/Tag"
	Agent_Untag_FullMethodName               = "/meshservice.Agent/Untag"
	Agent_Tags_FullMethodName                = "/meshservice.Agent/Tags"
	Agent_RTT_FullMethodName                 = "/meshservice.Agent/RTT"
)
...
func (c *agentClient) Info(ctx context.Context, in *AgentEmpty, opts ...grpc.CallOption) (*MeshInfo, error) {
	out := new(MeshInfo)
	err := c.cc.Invoke(ctx, Agent_Info_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) Nodes(ctx context.Context, in *AgentEmpty, opts ...grpc.CallOption) (Agent_NodesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[0], Agent_Nodes_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) WaitForChangeInMesh(ctx context.Context, in *WaitInfo, opts ...grpc.CallOption) (Agent_WaitForChangeInMeshClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[1], Agent_WaitForChangeInMesh_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) Tag(ctx context.Context, in *NodeTag, opts ...grpc.CallOption) (*TagResult, error) {
	out := new(TagResult)
	err := c.cc.Invoke(ctx, Agent_Tag_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) Untag(ctx context.Context, in *NodeTag, opts ...grpc.CallOption) (*TagResult, error) {
	out := new(TagResult)
	err := c.cc.Invoke(ctx, Agent_Untag_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) Tags(ctx context.Context, in *AgentEmpty, opts ...grpc.CallOption) (Agent_TagsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[2], Agent_Tags_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) RTT(ctx context.Context, in *AgentEmpty, opts ...grpc.CallOption) (Agent_RTTClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[3], Agent_RTT_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _Agent_Tag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_Tag_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Agent_Untag_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Agent_Untag_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
